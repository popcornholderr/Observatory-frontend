...
export default function Results() {
  ...
  useEffect(() => {
    const fetchResults = async () => {
      try {
        const res = await fetch(`${API_URL}/api/analysis/${id}/results`);
        if (res.ok) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginBottom: '-1rem' }}>
        <a href={`${API_URL}/api/analysis/${id}/export/json`} download className="btn-secondary" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        {visualizations?.waveform && (
          <div className="glass-panel" style={{ padding: '1.5rem' }}>
            ...
            <img src={`${API_URL}/data/results/${visualizations.waveform}`} alt="Waveform" style={{ width: '100%', height: 'auto', borderRadius: '4px' }} />
          </div>
        )}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
          ...
          {visualizations?.fft && (
            <div className="glass-panel" style={{ padding: '1.5rem' }}>
              ...
              <img src={`${API_URL}/data/results/${visualizations.fft}`} alt="FFT" style={{ width: '100%', height: 'auto', borderRadius: '4px' }} />
            </div>
          )}
          ...
          {visualizations?.spectrogram && (
            <div className="glass-panel" style={{ padding: '1.5rem' }}>
              ...
              <img src={`${API_URL}/data/results/${visualizations.spectrogram}`} alt="Spectrogram" style={{ width: '100%', height: 'auto', borderRadius: '4px' }} />
            </div>
          )}
        </div>
        ...
        {visualizations?.iq && (
          <div className="glass-panel" style={{ padding: '1.5rem', width: '50%', margin: '0 auto' }}>
            ...
            <img src={`${API_URL}/data/results/${visualizations.iq}`} alt="IQ Constellation" style={{ width: '100%', height: 'auto', borderRadius: '4px' }} />
          </div>
        )}
